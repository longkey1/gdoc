...
gdoc is a CLI client for Google Docs. It uses the Google Docs API and Drive API to list documents and retrieve their content in plain text, JSON, or Markdown format. Built with Go 1.25, cobra, and viper.
...
- Go version managed via `got` command (`got path 1.25`)
